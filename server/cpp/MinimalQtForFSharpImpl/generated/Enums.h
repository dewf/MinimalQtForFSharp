...
namespace Enums
{
    ...
    enum WindowFlagsFlags : uint32_t {
        Widget = 0x00000000,
        Window = 0x00000001,
    ...
    typedef int32_t ToolBarAreas;
    enum ToolBarAreasFlags : int32_t {
        LeftToolBarArea = 0x1,
    ...
    typedef int32_t FocusPolicy;
    enum FocusPolicyFlags : int32_t {
        NoFocus = 0,
        TabFocus = 0x1,
        ClickFocus = 0x2,
    ...
    typedef int32_t DropActionSet;
    enum DropActionSetFlags : int32_t {
        Ignore = 0,
        Copy = 0x1,
        Move = 0x2,
        Link = 0x4,
    ...
    typedef uint32_t InputMethodHints;
    enum InputMethodHintsFlags : uint32_t {
        ImhNone = 0x0,
        ImhHiddenText = 0x1,
    ...
    typedef int32_t MouseButtonSet;
    enum MouseButtonSetFlags : int32_t {
        NoButton = 0x00000000,
        LeftButton = 0x00000001,
        RightButton = 0x00000002,
        MiddleButton = 0x00000004,
