...
namespace PaintResources
{
    ...
    void Handle_createColor__wrapper() {
        ...
        auto name = Color::Constant__pop();
        Color__push(Handle_createColor(_this, name));
    }
    ...
    void Handle_createColor_overload1__wrapper() {
        ...
        auto g = ni_popInt32();
        auto b = ni_popInt32();
        Color__push(Handle_createColor(_this, r, g, b));
    }
    ...
    void Handle_createColor_overload2__wrapper() {
        ...
        auto b = ni_popInt32();
        auto a = ni_popInt32();
        Color__push(Handle_createColor(_this, r, g, b, a));
    }
